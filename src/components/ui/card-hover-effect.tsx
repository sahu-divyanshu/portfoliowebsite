    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <div
            className={cn(
              "rounded-2xl h-full sm:w-full w-52  p-4 overflow-hidden bg-black border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
              className
            )}
          >
